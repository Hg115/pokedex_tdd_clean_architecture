...
import 'get_pokemon_id_test.mocks.dart';

void main() {
  late GetConcreteId usecase;
  late MockPokedexRepository mockPokedexRepository;

  setUp(() {
    mockPokedexRepository = MockPokedexRepository();
    usecase = GetConcreteId(mockPokedexRepository);
  });
  ...
  const tPokedexId = Pokemon(
      ...
      weight: 40);
  test(
    'should get id pokemon for the number from the repository',
    () async {
